...
const VARIANT_STYLES: Record<Variant, string> = {
  primary:
    'p-2 bg-zinc-100 hover:bg-zinc-300 active:bg-zinc-300 disabled:bg-zinc-300 rounded-md text-zinc-900',
  secondary:
    'p-2 bg-zinc-900 hover:bg-zinc-800 active:bg-zinc-800 disabled:bg-zinc-800 rounded-md text-zinc-100',
  empty: '',
};
